    ...
    <div className="bg-white p-6 rounded-xl border border-slate-200 h-fit sticky top-24 shadow-sm">
      <div className="flex items-center justify-between pb-4 mb-4 border-b">
        ...
        <Button 
          ...
          size="sm" 
          onClick={onReset} 
          className="text-xs text-green-700 hover:text-green-700 h-auto p-0"
        >
          Clear All
        </Button>
      </div>
      ...
      <div className="mb-6">
        ...
        <select 
          ...
          className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-600 text-slate-700"
        >
      ...
      <div className="mb-4">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-xs font-bold text-green-700">₹{(maxFees / 100000).toFixed(1)}L</span>
        </div>
        <Slider 
          min={50000} 
          max={400000} 
